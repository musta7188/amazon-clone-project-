  ...
  return (
    <div className="home">
      <div className="home__container">
          ...
          price={40.99} 
          image="https://images.samsung.com/is/image/samsung/uk/galaxy-note20/gallery/uk-galaxy-watch3-r840-sm-r840nzsaeua-frontmysticsilver-274582207?$PD_GALLERY_L_SHOP_JPG$" rating={5} />
          <Product 
          id="34324"
          price={23.99}
          title="Kenwood kMix stand Mixer for Baking,
